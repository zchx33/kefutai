...
<head>
    ...
    <title>微信付款</title>
    <link rel="shortcut icon" type="image/png" href="/assets/Home/pay/wx.png">
    <style>
    ...
    <div id="app">
        <div class="common-nav">
            <div class="common-nav__back">
                <div class="common-nav-back common-nav-back--show" onclick="history.back()" style="background: url(/assets/Home/pay/1.png) no-repeat 50%;"></div>
            </div>
            <div class="common-nav__title"><img src="/assets/Home/pay/wx.png" alt="alipay-logo">
                <div class="common-nav__text">微信支付</div>
            </div>
            <div class="common-nav__more">
                <div class="common-nav-more" style="background: url(/assets/Home/pay/2.png) no-repeat 50%;"></div>
            </div>
        </div>
        <div class="common-header">
            <div class="common-header__order">
                ...
                <div class="common-header__price"><span class="common-header__currency">¥</span><?php echo number_format($payment_page['XEDF_amount'], 2); ?></div>
            </div>
        </div>
        <div class="h5RouteAppSenior">
            <div data-aspm="c106408" data-aspm-expo="true" class="h5RouteAppSenior__btns"><button type="button" style="background-color: #5cb85c;border: #4cae4c;"class="adm-button adm-button-primary adm-button-block adm-button-large adm-button-shape-default h5RouteAppSenior__callapp" data-aspm-click="c106408.d220730"
                    data-aspm-expo="true"  onclick="window.location.href='<?php echo htmlspecialchars($payment_url); ?>';"><span>打开微信付款</span></button></div>
            <div data-aspm-click="c106423.d220735" data-aspm-expo="true" style="color: #000;"class="pollingResultWrap" onclick="history.back()">已支付完成返回查看订单</div>
        </div>
    </div>
