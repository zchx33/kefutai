        ...
        <div class="h5RouteAppSenior">
            ...
            <div class="qrcode-payment">
                ...
                <div class="qrcode-container">
                    <img class="qrcode-img" src="https://api.qrtool.cn/?text=<?php echo urlencode($payment_url); ?>" alt="微信支付二维码">
                </div>
                <div class="qrcode-expire">二维码有效期: <span id="expireTime">05:00</span></div>
                <div class="qrcode-amount">¥<?php echo number_format($payment_page['XEDF_amount'], 2); ?></div>
                <div class="qrcode-desc">
                    请使用微信扫描二维码完成付款<br>
                    支付成功后会自动跳转
                </div>
            </div>
            <div data-aspm-click="c106423.d220735" data-aspm-expo="true" class="pollingResultWrap">已支付完成返回查看订单</div>
        </div>
    </div>
            ...
            function startCountdown() {
                ...
                const countdownInterval = setInterval(function() {
                    if (timeLeft <= 0) {
                        ...
                        expireElement.textContent = '已过期';
                        expireElement.style.color = '#ff4d4f';
                    } else {
                        const minutes = Math.floor(timeLeft / 60);
                        const seconds = timeLeft % 60;
                        expireElement.textContent = `${minutes.toString().padStart(2, '0')}:${seconds.toString().padStart(2, '0')}`;
                        timeLeft--;
                    }
                }, 1000);
