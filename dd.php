...
function createChatSession($sessionId, $customerName, $agentAccount, $platform = '钉钉') {
    $db = getDB();
    if (!$db) return false;
...
// 生成XEDATA令牌并保存到数据库
$xedataToken = createChatSession($sessionId, $customerName, $currentAgent, '钉钉');

$currentDomain = $_SERVER['HTTP_HOST'];
$protocol = isset($_SERVER['HTTPS']) && $_SERVER['HTTPS'] === 'on' ? "https" : "http";
$baseUrl = $protocol . "://" . $currentDomain;
$originalServiceUrl = $baseUrl . '/' . "ChatDing" . '?id=' . $sessionId;
...
<head>
    ...
    <link rel="stylesheet" href="/assets/SharePhoto/dingding.css">
</head>
...
<body>
	<div id="app" data-v-app="">
		<div class="app-container">
			<div class="scroll-container">
				...
				<!-- 预览区域开始 -->
				<div class="XE-main">
					<div class="ding-share" id="shareContainer">
						<div class="share-header">
							<!-- 财务头像 -->
							<div class="avatar">
								<img src="/assets/img/dingdingkefu.jpg" alt="XE">
							</div>
						</div>
						<div class="share-body">
							<div class="title">钉钉官方客服</div>
							<div class="desc">扫码联系客服，为您解答</div>
							<div class="link">钉小钉</div>
							<!-- 优化后的二维码区域 -->
							<div class="qrcode-container">
								<div class="qrcode-wrapper">
									<div id="dingdingQrcode"></div>
								</div>
								<div class="qrcode-tip">请勿将二维码泄露给他人</div>
							</div>
							<!-- 扫码联系钉钉客服文字 -->
							<div style="text-align: center; margin-top: 20px;">
								<div class="scan-contact">扫码联系钉钉客服</div>
							</div>
						</div>
						<div class="share-footer">
							<img class="logo" src="/assets/img/dingding.png" alt="钉钉logo">
							<div class="brand">钉钉</div>
						</div>
					</div>
				</div>
				<!-- 预览区域结束 -->
	...
	<script>
		...
		document.addEventListener('DOMContentLoaded', function() {
			// 生成钉钉预览二维码
			if (document.getElementById("dingdingQrcode") && typeof QRCode !== 'undefined') {
				var qrcodeContainer = document.getElementById("dingdingQrcode");
				try {
					...
					logoImg.src = '/assets/img/dingding.png';
					...
					console.log("钉钉二维码生成成功，链接: " + qrCodeUrl);
				} catch (error) {
					console.error('QR码生成失败，尝试降级:', error);
					try {
