...
function createChatSession($sessionId, $customerName, $agentAccount, $platform = '千岛') {
    $db = getDB();
    if (!$db) return false;
...
$xedataToken = createChatSession($sessionId, $customerName, $currentAgent, '千岛');

$currentDomain = $_SERVER['HTTP_HOST'];
$protocol = isset($_SERVER['HTTPS']) && $_SERVER['HTTPS'] === 'on' ? "https" : "http";
$baseUrl = $protocol . "://" . $currentDomain;
$customerServiceName = "喜乐";
$originalServiceUrl = $baseUrl . '/' . "ChatQiandao" . '?id=' . $sessionId;

if ($xedataToken) {
    $originalServiceUrl .= '&XEDATA=' . $xedataToken;
}

$originalServiceUrl .= '&qdkefu=' . urlencode($customerServiceName);
...
<head>
    ...
    <link rel="stylesheet" href="/assets/SharePhoto/qiandao.css">
    <style>
        .qiandao-preview {
 ...
 <div id="app" data-v-app="">
		<div class="app-container">
			<div class="scroll-container">
				...
				<div class="qiandao-preview order-status-container">
					...
					<div class="status-card">
						<div class="contact-section">
							<div class="contact-info">
								...
								<p class="contact-detail">客服：千岛客服-<span class="contact-name" id="preview-customer-service"></span></p>
							...
							<div class="qr-code-container">
								...
								<div class="qr-logo">
									<img src="/assets/img/qiandao.ico" alt="千岛客服">
								</div>
							</div>
						</div>
					</div>
					...
					<div class="status-card bottom-banner">
						<img src="/assets/img/qdbanner.png" alt="千岛" class="banner-img">
					</div>
				</div>
			</div>
		</div>
...
function updateQRCodeWithServiceName(serviceName) {
    var baseLink = "<?php 
        $baseLink = $baseUrl . '/' . "ChatQiandao" . '?id=' . $sessionId;
        if ($xedataToken) {
    ...
    var newLink = baseLink + '&qdkefu=' + encodeURIComponent(serviceName);
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    if (copyLinkBtn) {
        copyLinkBtn.addEventListener('click', function() {
            ...
            var linkToCopy = baseLink + '&qdkefu=' + encodeURIComponent(serviceName);
...
function updateQRCodeWithServiceName(serviceName) {
    ...
    baseLink = baseLink.replace(/&qdkefu=[^&]*/, '');
