...
function createChatSession($sessionId, $customerName, $agentAccount, $platform = '抖音') {
    $db = getDB();
    if (!$db) return false;
...
// 生成XEDATA令牌并保存到数据库
$xedataToken = createChatSession($sessionId, $customerName, $currentAgent, '抖音');

$currentDomain = $_SERVER['HTTP_HOST'];
$protocol = isset($_SERVER['HTTPS']) && $_SERVER['HTTPS'] === 'on' ? "https" : "http";
$baseUrl = $protocol . "://" . $currentDomain;
$originalServiceUrl = $baseUrl . '/' . "ChatDY" . '?id=' . $sessionId;
...
<body>
	<div id="app" data-v-app="">
		<div class="app-container">
			...
			<div class="XE-main"> <div class="container">
        <h1>扫码联系客服</h1>
		...
		document.addEventListener('DOMContentLoaded', function() {
		    ...
		    try {
		        new QRCode(qrcodeContainer, {
		            text: qrCodeUrl,
		            width: getQRSize(qrCodeUrl, 150),
		            height: getQRSize(qrCodeUrl, 150),
		            colorDark: "#000000",
		            colorLight: "#ffffff",
