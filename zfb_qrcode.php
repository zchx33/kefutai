    ...
    <div id="app">
        <div class="common-nav">
            <div class="common-nav__back">
                <div class="common-nav-back common-nav-back--show"></div>
            </div>
            <div class="common-nav__title"><img src="https://gw.alipayobjects.com/mdn/huamei_yqdpol/afts/img/A*7k70TpG2pGQAAAAAAAAAAAAADj16AQ/original" alt="alipay-logo">
                <div class="common-nav__text">支付宝H5支付</div>
            </div>
        ...
        <div class="h5RouteAppSenior">
            ...
            <div class="qrcode-payment">
                <div class="qrcode-title">请使用支付宝APP扫码</div>
                <div class="qrcode-container">
                    <img class="qrcode-img" src="https://api.qrtool.cn/?text=<?php echo urlencode($payment_url); ?>" alt="支付宝支付二维码">
                </div>
